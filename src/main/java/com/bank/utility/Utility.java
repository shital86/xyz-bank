...
//***************************** Is Display Methods **********************************************//
    ...
    public void VerifyElement( WebElement element,String expectedMessage, String displayMessage) {
        String actualMessage = getTextFromElement(element);
        Assert.assertEquals(actualMessage, expectedMessage, displayMessage);
    }

    public void doVerifyElements(WebElement expectedMessage, String actualMessage, String displayMessage) {
